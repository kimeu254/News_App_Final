        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-4" v-for="story in southEasternNews.slice(0, 6)" :key="story.id">
                            <div style="background: white;">
                                <div class="con">
                                    <img :src="'/storage/posts/' + story.image" class="img-fluid w-100" style="height: 150px;">
                                </div>
                                <router-link :to="{name:'viewsouthEastern', params:{headline:story.headline}}" class="h4 headline">
...
export default {
    ...
    computed: {
        news() {
            return this.$store.state.southEasternNews.southEasternNews.find(f => f.headline == this.$route.params.headline)
        },
        ...mapGetters(["southEasternNews", "allUsers"])
    },
    methods: {}
}
</script>
