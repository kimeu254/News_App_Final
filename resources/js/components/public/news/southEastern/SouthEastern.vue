            ...
            <div class="col-md-8">
                <div>
                    <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
                        <div class="py-4" v-for="news in southEasternNews.slice(0,6)" :key="news.id"> 
                            <div class="row">
                                <div class="col-md-6">
                                    <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 300px; object-fit: cover;">
                                </div>
                                <div class="col-md-6 py-4">
                                    <router-link :to="{name:'viewsouthEastern', params:{headline:news.headline}}" class="h4 text-dark" style="text-decoration: none;">
                                        {{news.headline}}
                                    </router-link>
                                </div>
                            </div>
                    ...
                    <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
                        <div class="py-4" v-for="news in southEasternNews.slice(6,12)" :key="news.id"> 
                            <div class="row">
                                <div class="col-md-6">
                                    <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 300px; object-fit: cover;">
                                </div>
                    ...
                    <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                        <div class="py-4" v-for="news in southEasternNews.slice(12,18)" :key="news.id"> 
                            <div class="row">
                                <div class="col-md-6">
                                    <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 300px; object-fit: cover;">
                                </div>
