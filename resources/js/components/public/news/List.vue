            ...
            <div class="col-md-8" style="">
                ...
                <div>
                    <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="story in news.slice(0,6)" :key="story.id">
                                    <div class="con">
                    ...
                    <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="story in news.slice(6,12)" :key="story.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + story.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
                    ...
                    <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="story in news.slice(12,18)" :key="story.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + story.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
