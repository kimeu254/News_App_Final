            ...
            <div class="col-md-8">
                ...
                <div>
                    ...
                    <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="news in politicsCategory.slice(6,11)" :key="news.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
                    ...
                    <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="news in politicsCategory.slice(11,17)" :key="news.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
