<template>
    <div class="container">
        <div class="row py-5">
            <div class="col-md-8">
                <div class="title px-2">Business</div>
                <div>
                    <div v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="news in businessCategory.slice(0,6)" :key="news.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
                                        <router-link :to="{name:'viewBusiness', params:{headline:news.headline}}" class="headline h5" style="">
                                            {{news.headline}}
                                        </router-link>
                                        <div class="d-flex">
                    ...
                    <div v-bind:class="{'hidden': openTab !== 2, 'block': openTab === 2}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="news in businessCategory.slice(6,12)" :key="news.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
                    ...
                    <div v-bind:class="{'hidden': openTab !== 3, 'block': openTab === 3}">
                        <div class="py-4"> 
                            <div class="row">
                                <div class="col-md-6" v-for="news in businessCategory.slice(12,18)" :key="news.id">
                                    <div class="con">
                                        <img :src="'/storage/posts/' + news.image" alt="" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                                    </div>
                                    <div class="py-3">
