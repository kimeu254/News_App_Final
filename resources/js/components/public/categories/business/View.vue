<template>
    <div class="container">
        <div class="py-3">
            <h6>Category <small style="font-size: 12px;">></small> Business</h6>
        </div>
        <div class="row">
            <div class="col-md-8">
                <div>
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-4" v-for="story in businessCategory.slice(0, 6)" :key="story.id">
                            <div style="background: white;">
                                <img :src="'/storage/posts/' + story.image" class="img-fluid w-100" style="height: 150px; object-fit: cover;">
                                <router-link :to="{name:'viewBusiness', params:{headline:story.headline}}" class="h4 text-dark" style="text-decoration: none;">
