    ...
    <div class="container-scroller">
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row shadow">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" ><img :src="'/storage/logos/Dark Blue Red White Generic News General News Logo (4)cropped1.png'" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" ><img :src="'/storage/logos/journalism.png'" alt="logo" /></a>
            </div>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-light text-capitalize">{{ user.first_name }} {{user.last_name}}</p>
                            </div>
                        </a>
                    ...
                    <li class="nav-item nav-profile">
                      <router-link :to="{name:'profile'}" class="nav-link">
                          ...
                          <div class="nav-profile-text d-flex flex-column">
                              ...
                              <span class="text-dark text-small">Author</span>
                          </div>
    ...
    .sidebar-icon-only .sidebar {
      ...
      .sidebar-icon-only .sidebar .nav {
        ...
        .sidebar-icon-only .sidebar .nav .nav-item {
          ...
          .sidebar-icon-only .sidebar .nav .nav-item.nav-profile span{
            display: none; }
          .sidebar-icon-only .sidebar .nav .nav-item.nav-profile img{
            display: block;
            margin-left: 10px;
           }
