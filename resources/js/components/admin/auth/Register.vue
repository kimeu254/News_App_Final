                    ...
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="first_name" v-model="user.first_name" id="first_name" placeholder="Enter first name" class="form-control">
                            </div>
                            <div class="form-group col-12">
                                <label for="name" class="font-weight-bold">Name</label>
                                <input type="text" name="last_name" v-model="user.last_name" id="last_name" placeholder="Enter last name" class="form-control">
                            </div>
